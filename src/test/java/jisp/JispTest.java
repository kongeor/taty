...
public class JispTest {
    ...
    @Test
    public void num() {
        assertEquals(NumberExpr_(5), readFirst("5").eval(env));
    }

    @Test
    public void def_sym() {
        assertEquals(NumberExpr_(1), readFirst("(def a 1)").eval(env));
        assertEquals(NumberExpr_(1), readFirst("a").eval(env));
    }

    @Test
    public void let() {
        assertEquals(NumberExpr_(1), readFirst("(let [a 1] a)").eval(env));
        try {
            assertEquals(NumberExpr_(1), readFirst("a").eval(env));
    ...
    public void let_mult_exp() {
        assertEquals(NumberExpr_(2), readFirst("(let [] 1 2)").eval(env));
    }

    @Test
    public void fn() {
        assertEquals(NumberExpr_(3), readFirst("((fn [a b] (+ a b)) 1 2)").eval(env));
    }

    @Test
    public void fn_mult_expr() {
        assertEquals(NumberExpr_(2), readFirst("((fn [] 1 2))").eval(env));
    }
    ...
    @Test
    public void do_exp() {
        assertEquals(NumberExpr_(3), readFirst("(do (def a 3) a").eval(env));
    }
    ...
    @Test
    public void apply() {
        assertEquals(NumberExpr_(6), readFirst("(apply + '(1 2 3)").eval(env));
    }

    @Test
    public void vararg() {
        assertEquals(NumberExpr_(6), readFirst("((vararg (fn [args] (apply + args))) 1 2 3)").eval(env));
    }
    ...
    public void nil_is_false() {
        assertEquals(NumberExpr_(2), readFirst("(if nil 1 2)").eval(env));
    }

    @Test
    public void false_is_false() {
        assertEquals(NumberExpr_(2), readFirst("(if false 1 2)").eval(env));
    }

    @Test
    public void nums_are_true() {
        assertEquals(NumberExpr_(1), readFirst("(if 5 1 2)").eval(env));
    }
